            ...
            <footer className="bg-white">
                    ...
                    <div className="row py-3">
                        ...
                        <div className="col-lg-4 col-md-6 mb-lg-0">
                            ...
                            <ul className="list-inline mt-4">
                                <li className="list-inline-item"><a href="" target="_blank" title="twitter"><i className="fab fa-2x fa-twitter black"></i></a></li>
                                <li className="list-inline-item"><a href="" target="_blank" title="facebook"><i className="fab fa-2x fa-facebook-f black "></i></a></li>
                                <li className="list-inline-item"><a href="" target="_blank" title="instagram"><i className="fab fa-2x fa-instagram black"></i></a></li>
                                <li className="list-inline-item"><a href="" target="_blank" title="pinterest"><i className="fab fa-2x fa-youtube black "></i></a></li>
                                <li className="list-inline-item"><a href="" target="_blank" title="vimeo"><i className="fab fa-2x fa-google black"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-light py-2">
                    <div className="container text-center">
                        <p className="text-muted mb-0 py-2">© 2020 LFM.NET All rights reserved.</p>
                    </div>
                </div>
            </footer>
